...
import { CreateBookController } from 'src/infra/api/controllers/book/create-book/create-book.controller';
import { DeleteBookController } from 'src/infra/api/controllers/book/delete-post/delete-book.controller';
import { FindAllBookController } from 'src/infra/api/controllers/book/find-all/find-all.book.controller';
import { FindOneBookController } from 'src/infra/api/controllers/book/find-one/find-one.book.controller';
import { UpdateBookController } from 'src/infra/api/controllers/book/update-book/update-book.controller';
