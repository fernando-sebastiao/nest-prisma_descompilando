...
import { CreateSaleController } from 'src/infra/api/controllers/sale/create-sale/create-sale.controller';
import { DeleteSaleController } from 'src/infra/api/controllers/sale/delete-sale/delete-sale.controller';
import { FindAllSaleController } from 'src/infra/api/controllers/sale/find-all/find-all.sale.controller';
import { FindOneSaleController } from 'src/infra/api/controllers/sale/find-one/find-one.sale.controller';
